...
namespace BITCollege_FV.Controllers
{
    public class HonoursStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HonoursStateId,LowerLimit,UpperLimit,TuitionRateFactor")] HonoursState honoursState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HonoursStateId,LowerLimit,UpperLimit,TuitionRateFactor")] HonoursState honoursState)
        {
            if (ModelState.IsValid)
            {
